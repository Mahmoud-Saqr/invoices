        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="/filter_customers" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-3 mt-3">
                                <label for="inputName" class="control-label"> القسم </label>
                                <select name="sections" class="form-control select2-no-search" onclick="console.log($(this).val())"
                                        onchange="console.log('change is firing')" required>
                                    <option value="empty" selected disabled> __حدد القسم__ </option>
                            ...
                            <div class="col-sm-12 col-md-3 mt-3">
                                ...
                                <select id="product" name="product" class="form-control select2-no-search" required>
                                    <option value="empty" selected disabled> __المنتج__ </option>
                                </select>
                            </div>

                            <div class="col-sm-12 col-md-3 mt-3" id="dateFrom">
                            ...
                            <div class="col-sm-12 col-md-3 mt-3" id="dateTo">
