                ...
                <td>
                    <div class="dropdown dropleft z-index-200">
                        ...
                        <div class="dropdown-menu tx-14">
                            ...
                            <a class="dropdown-item"
                               href="{{ URL::route('status_edit', [$invoice -> id] ), 'test' }}">
                                <i class="typcn typcn-edit text-secondary ml-2"></i> تعديل حالة الدفع </a>

                            <a class="dropdown-item"
                               href="{{ url('invoices_details') }}/{{ $invoice -> id }}">
                            ...
                            <a class="dropdown-item" href="#" data-id = "{{ $invoice -> id }}"
                               data-toggle="modal" data-invoice_number="{{ $invoice -> invoice_number }}" data-target="#invoice_del">
