		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="d-flex justify-content-around align-items-center gap-2 mt-3 mb-5 m-1 flex-column">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/profile.jpg')}}">
{{--                            <span class="avatar-status profile-status bg-green"></span>--}}
						</div>
						<div class="user-info">
							<h4 class="font-weight-semibold mg-b-5 mt-3">{{ Auth::user() -> name }}</h4>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/' . $page='home') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/>
                ...
                @can('invoices')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @can('invoices list')
                            <li><a class="slide-item" href="{{ url('/' . $page='search_invoices') }}"> بحث صوتي </a></li>
                            @endcan
                ...
                @can('sections and products')
                    <li class="side-item side-item-category">الاقسام والمنتجات</li>
                    <li class="slide">
