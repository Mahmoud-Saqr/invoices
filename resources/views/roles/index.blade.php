                ...
                <div class="d-flex justify-content-between">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary btn-sm" href="{{ route('roles.create') }}"><i class="fas fa-plus ml-2"></i>اضافة صلاحية</a>
                        </div>
                    </div>
                    <br>
                </div>
                            ...
                            @foreach ($roles as $key => $role)
                                <tr>
                                    ...
                                    @if ($role->name !== 'owner')
                                            ...
                                            {!! Form::submit('حذف', ['class' => 'btn btn-danger btn-sm']) !!} {!! Form::close() !!}
                                    @endif
                                    </td>
                                </tr>
                            @endforeach
